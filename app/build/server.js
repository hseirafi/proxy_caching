...
const routes = {
  ...
  children: [{
    path: '/',
    load: () => __webpack_require__.e/* import() */(5).then(__webpack_require__.bind(null, 49))
  }, {
    path: '/contact',
    load: () => __webpack_require__.e/* import() */(6).then(__webpack_require__.bind(null, 50))
  }, {
    path: '/login',
    load: () => __webpack_require__.e/* import() */(4).then(__webpack_require__.bind(null, 51))
  }, {
    path: '/register',
    load: () => __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 52))
  }, {
    path: '/about',
    load: () => __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 53))
  }, {
    path: '/privacy',
    load: () => __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 54))
  }, {
    path: '/admin',
    load: () => __webpack_require__.e/* import() */(7).then(__webpack_require__.bind(null, 55))
  },

  // Wildcard routes, e.g. { path: '*', ... } (must go last)
  {
    path: '*',
    load: () => __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 56))
  }],
