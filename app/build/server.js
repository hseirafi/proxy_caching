...
const routes = {
  ...
  children: [{
    path: '/',
    load: () => __webpack_require__.e/* import() */(6).then(__webpack_require__.bind(null, 49))
  }, {
    path: '/landing',
    load: () => __webpack_require__.e/* import() */(5).then(__webpack_require__.bind(null, 50))
  }, {
    path: '/contact',
    load: () => __webpack_require__.e/* import() */(7).then(__webpack_require__.bind(null, 51))
  }, {
    path: '/login',
    ...
    path: '/admin',
    load: () => __webpack_require__.e/* import() */(8).then(__webpack_require__.bind(null, 56))
  },
